  ...
  setHtml(rootEl) {
    ...
    const html = `
      <div class="UML-interface edit-node">
        ...
        + attribute1:type = defaultValue<br/>
        + attribute2:type<br/>
        - attribute3:type
        </div>
        <div value="" contenteditable="true" oninput="setData('.UML-all .body-${this.props.model.id}', 'body')" class="footer edit-node footer-${this.props.model.id}">
    ...
    window.setData = (e, key) => {
      ...
      graphModel.eventCenter.emit("input:change", { model, key, val: el.value || el.innerHTML });
    }
  }
}
